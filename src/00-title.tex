\begin{titlepage}
	...
	\begin{center}
		...
		<<Метод персонализации пользователей социальных сетей для целевой рекламы с использованием нейронных сетей>>
	...
	\begin{table}[h!]
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Студент группы \textbf{ИУ7-85Б} & \uline{\mbox{\hspace*{4cm}}} & \uline{\textbf{Д.О. Склифасовский}} \\
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Руководитель ВКР & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{К.Л. Тассов} \hfill} \\
			& \scriptsize (Подпись, дата) & \scriptsize (И.О. Фамилия)
		\end{signstabular}
